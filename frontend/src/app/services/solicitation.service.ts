...
import { ContractModification, ContractModificationCreate } from '../models/contract_modification';
 ...
 * compares this with `contract_modification-list.component.ts`, which hardcodes
